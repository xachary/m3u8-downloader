            ...
            nalByteStream.on("data", function (data) {
              ...
              switch (data[0] & 0x1f) {
                ...
                case 0x06:
                  ...
                  event.escapedRBSP = discardEmulationPreventionBytes(
                    data.subarray(1)
                  );
                  break;
                case 0x07:
      ...
      8: [
        function (require, module, exports) {
          ...
          CaptionStream.prototype.push = function (event) {
            ...
            if (
              sei.payloadType !== cea708Parser.USER_DATA_REGISTERED_ITU_T_T35
            ) {
              return;
            }
            ...
            newCaptionPackets = cea708Parser.parseCaptionPackets(
              event.pts,
              userData
            );
            this.captionPackets_ =
          ...
          var ROWS = [
            0x1100, 0x1120, 0x1200, 0x1220, 0x1500, 0x1520, 0x1600, 0x1620,
            ...
            this.push = function (bytes) {
              ...
              while (endIndex < everything.byteLength) {
                ...
                if (
                  ...
                  this.trigger(
                    "data",
                    everything.subarray(startIndex, endIndex)
                  );
          ...
          TransportParseStream = function () {
            ...
            parsePmt = function (payload, pmt) {
              ...
              while (offset < tableEnd) {
                ...
                offset +=
                  (((payload[offset + 3] & 0x0f) << 8) | payload[offset + 4]) +
                  5;
              }
            ...
            this.processPes_ = function (packet, offset, result) {
              ...
              if (result.pid === this.programMapTable.video) {
                ...
                result.streamType =
                  this.programMapTable["timed-metadata"][result.pid];
              }
          ...
          ElementaryStream = function () {
            var self = this,
              ...
              flushStream = function (stream, type, forceFlush) {
                ...
                packetFlushable =
                  type === "video" || event.packetLength <= stream.size;
      ...
      18: [
        function (require, module, exports) {
          ...
          moov = function (tracks) {
            ...
            return box.apply(
              null,
              [types.moov, mvhd(customDuration)]
                .concat(boxes)
                .concat(mvex(tracks))
            );
          };
            ...
            traks.forEach(function (trak) {
              ...
              hdlrs.forEach(function (hdlr, index) {
                ...
                if (handlerType === "vide") {
                  ...
                  trackId =
                    version === 0 ? view.getUint32(12) : view.getUint32(20);
                ...
                if (codecBox) {
                  ...
                  if (/^[a-z]vc[1-9]$/i.test(track.codec)) {
                    ...
                    if (
                      ...
                      track.codec +=
                        "." +
                        toHexString((codecConfig[20] >>> 2) & 0x3f).replace(
                          /^0/,
                          ""
                        );
                    } else {
        ...
        function (require, module, exports) {
          ...
          AudioSegmentStream = function (track, options) {
            ...
            this.flush = function () {
              ...
              frameDuration = Math.ceil(
                (ONE_SECOND_IN_TS * 1024) / track.samplerate
              );
          ...
          VideoSegmentStream = function (track, options) {
            ...
            this.getGopForFusion_ = function (nalUnit) {
              ...
              for (i = 0; i < this.gopCache_.length; i++) {
                ...
                dtsDistance =
                  nalUnit.dts - currentGop.dts - currentGop.duration;
          ...
          Transmuxer = function (options) {
            ...
            this.setupAacPipeline = function () {
              ...
              pipeline.audioTimestampRolloverStream =
                new m2ts.TimestampRolloverStream("audio");
            ...
            this.setupTsPipeline = function () {
              ...
              pipeline.timestampRolloverStream =
                new m2ts.TimestampRolloverStream();
              pipeline.adtsStream = new AdtsStream();
          ...
          var parseCaptionPackets = function (pts, userData) {
            ...
            for (i = 0; i < count; i++) {
              ...
              if (userData[offset + 2] & 0x04) {
                data.ccData =
                  (userData[offset + 3] << 8) | userData[offset + 4];
                results.push(data);
              }
            }
            return results;
...
class Downloader {
  ...
  applyURL(targetURL, baseURL) {
    baseURL = baseURL || this.location.href;
  ...
  conversionMp4(data, index, callback) {
    ...
    transmuxer.on("data", (segment) => {
      if (index === this.rangeDownload.startSegment - 1) {
        ...
        callback(Buffer.from(data.buffer));
      } else {
        callback(Buffer.from(segment.data));
      }
    });
...
if (process.argv[2]) {
  try {
    const downloader = new Downloader(process.argv[2], process.argv[3]);
